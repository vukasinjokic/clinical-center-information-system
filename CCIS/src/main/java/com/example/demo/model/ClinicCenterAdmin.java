...
public class ClinicCenterAdmin extends User {
    ...
    public ClinicCenterAdmin(Integer id, String email, String password, String name, String lastName, String address, String city, String country, String phone, String socialSecurityNumber) {
